...
export function FijImport() {
  const [rows, setRows] = useState<ParsedRow[]>([]); const [progress, setProgress] = useState(''); const [importing, setImporting] = useState(false);
